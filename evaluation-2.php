...
<div class="cont col3">
  <div id="container">
    ...
    <!------------------------------------------------------------------------------------------------------------------------------>
    <?php
$sol=array('a','d','b','c','d','d','a','b','d','a','b','d','b','b','a','d','b','c','d','c','c','b','d','a','a');
$note=0;
$a=0;
echo "<h3>";
for($i=0; $i<25; $i++)
...
echo"</h3>";
echo"<h3>";
echo "<font color=\"grey\">your note is ".$note;

if ($note>=24)
    echo "Hooray! you did it!";
else 
    echo " sorry, Next time you'll do much better ";
echo "<br>";
echo"</h3>";
echo "<h2>";
...
<?php
    $idCon=connex();
	$req="update users set derg=".$note." where email=\"".$_SESSION['email']."\"";
